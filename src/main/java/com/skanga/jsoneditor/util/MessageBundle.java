...
/**
 * This class provides utility functions for retrieving localized UI messages from a resource bundle.<br>
 * By default, it loads messages from {@value #RESOURCES_PATH}.
 * 
